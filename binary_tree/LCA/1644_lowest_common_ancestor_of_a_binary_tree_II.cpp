...
private:
    TreeNode* result;
    // return 0: both val1 and val2 can't be found in "root"
    // return 1: only one of val1 and val2 can be found in "root"
    // return 2: both val1 and val2 can be found in "root"
